...
function withLume(config) {
  var _a, _b, _c;
  const existingContent = Array.isArray(config.content) ? config.content : (_b = (_a = config.content) == null ? void 0 : _a.files) != null ? _b : [];
  return __spreadProps(__spreadValues({}, config), {
    ...
    plugins: [
      ...(_c = config.plugins) != null ? _c : [],
      plugin__default.default(({ addBase }) => {
        addBase({
          ":root": {
            "--background": "0 0% 100%",
